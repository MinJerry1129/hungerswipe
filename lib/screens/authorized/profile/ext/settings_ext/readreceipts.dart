...
class SettingsReadReceipts extends StatefulWidget {
  const SettingsReadReceipts({Key? key}) : super(key: key);
  _SettingsReadReceiptsState createState() => _SettingsReadReceiptsState();
}

class _SettingsReadReceiptsState extends State<SettingsReadReceipts> {
