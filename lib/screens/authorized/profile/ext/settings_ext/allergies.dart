...
class SettingsAllergies extends StatefulWidget {
  const SettingsAllergies({Key? key}) : super(key: key);
  _SettingsAllergiesState createState() => _SettingsAllergiesState();
}

class _SettingsAllergiesState extends State<SettingsAllergies> {
