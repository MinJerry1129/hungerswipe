...
class SettingsPushNotifs extends StatefulWidget {
  const SettingsPushNotifs({Key? key}) : super(key: key);
  _SettingsPushNotifsState createState() => _SettingsPushNotifsState();
}

class _SettingsPushNotifsState extends State<SettingsPushNotifs> {
