...
/// implementation of [SmallerTypeAheadField], that allows the value to be saved,
/// validated, etc.
///
/// See also:
///
/// * [SmallerTypeAheadField], A [TextField](https://docs.flutter.io/flutter/material/TextField-class.html)
/// that displays a list of suggestions as the user types
class SmallerTypeAheadFormField<T> extends FormField<String> {
  /// The configuration of the [TextField](https://docs.flutter.io/flutter/material/TextField-class.html)
  /// that the SmallerTypeAhead widget displays
  final TextFieldConfiguration textFieldConfiguration;

  /// Creates a [SmallerTypeAheadFormField]
  SmallerTypeAheadFormField(
      {Key? key,
      String? initialValue,
      ...
      : assert(
        ...
        super(
            ...
            builder: (FormFieldState<String> field) {
              final _SmallerTypeAheadFormFieldState state =
                  field as _SmallerTypeAheadFormFieldState<dynamic>;

              return SmallerTypeAheadField(
  ...
  @override
  _SmallerTypeAheadFormFieldState<T> createState() =>
      _SmallerTypeAheadFormFieldState<T>();
}

class _SmallerTypeAheadFormFieldState<T> extends FormFieldState<String> {
  ...
  @override
  SmallerTypeAheadFormField get widget =>
      super.widget as SmallerTypeAheadFormField<dynamic>;
  ...
  @override
  void didUpdateWidget(SmallerTypeAheadFormField oldWidget) {
...
/// See also:
///
/// * [SmallerTypeAheadFormField], a [FormField](https://docs.flutter.io/flutter/widgets/FormField-class.html)
/// implementation of [SmallerTypeAheadField] that allows the value to be saved,
/// validated, etc.
class SmallerTypeAheadField<T> extends StatefulWidget {
  /// Called with the search pattern to get the search suggestions.
  ///
  /// This callback must not be null. It is be called by the SmallerTypeAhead widget
  ...
  ///
  /// This callback must not be null. It is called by the SmallerTypeAhead widget and
  ...
  ///
  /// This callback must not be null. It is called by the SmallerTypeAhead widget for
  ...
  /// Creates a [SmallerTypeAheadField]
  ...
  @override
  _SmallerTypeAheadFieldState<T> createState() =>
      _SmallerTypeAheadFieldState<T>();
}

class _SmallerTypeAheadFieldState<T> extends State<SmallerTypeAheadField<T>>
  ...
  // Will have a value if the Smallertypeahead is inside a scrollable widget
  ...
  void didChangeDependencies() {
    ...
    if (scrollableState != null) {
      // The SmallerTypeAheadField is inside a scrollable widget
...
/// Supply an instance of this class to the [SmallerTypeAhead.suggestionsBoxDecoration]
...
/// Supply an instance of this class to the [SmallerTypeAhead.textFieldConfiguration]
...
class TextFieldConfiguration {
  ...
  /// A typical use case for this field in the SmallerTypeAhead widget is to set the
...
class _SuggestionsBox {
  ...
  void _adjustMaxHeightAndOrientation() {
    SmallerTypeAheadField widget = context.widget as SmallerTypeAheadField;
...
/// Supply an instance of this class to the [SmallerTypeAhead.suggestionsBoxController]
